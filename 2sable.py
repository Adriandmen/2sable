...
def pop_stack(amount=1):
    if amount == 1:
        ...
        if len(stack) > 1:
            ...
            if len(recent_inputs) != 0:
                return recent_inputs[0], recent_inputs[0]
            a = input()
            if is_array(a):
                a = ast.literal_eval(a)
        ...
        if len(stack) > 2:
            ...
            if len(recent_inputs) != 0:
                return a, recent_inputs[0], recent_inputs[0]
            b = input()
            if is_array(b):
                b = ast.literal_eval(b)
            ...
            if len(recent_inputs) != 0:
                return recent_inputs[0], recent_inputs[0], recent_inputs[0]
        ...
        try:
            ...
            if current_command == "h":
                ...
                if type(a) is list and type(b) is list:
                    temp_list = []
                    for Q in len(a):
                        temp_list.append(convert_to_base(abs(ast.literal_eval(str(a[Q]))), ast.literal_eval(str(b[Q]))))
                    stack.append(temp_list)
                elif type(a) is list:
                    temp_list = []
                    for Q in a:
